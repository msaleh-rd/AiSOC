...
[`services/agents/tests/eval_data/synthetic_incidents.json`](https://github.com/beenuar/AiSOC/blob/main/services/agents/tests/eval_data/synthetic_incidents.json).
The corpus is regenerated by [`scripts/generate_eval_incidents.py`](https://github.com/beenuar/AiSOC/blob/main/scripts/generate_eval_incidents.py)
...
| Driver            | [`scripts/run_evals.py`](https://github.com/beenuar/AiSOC/blob/main/scripts/run_evals.py) with `--wet` (added by T2.4) |
...
[`package.json`](https://github.com/beenuar/AiSOC/blob/main/package.json).
...
[`apps/docs/docs/operations/credentials.md`](https://github.com/beenuar/AiSOC/blob/main/apps/docs/docs/operations/credentials.md).
...
- The [eval-results branch](https://github.com/beenuar/AiSOC/tree/eval-results)
  for every historic snapshot.
- The [v8.0 north-star plan](https://github.com/beenuar/AiSOC/blob/main/plans/future-release-implementation-plan.md)
